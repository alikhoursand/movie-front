<div class="navbar  bg-base-100 p-0 flex-wrap">
    <div class="basis-full flex justify-between items-center px-2 py-4  max-w-screen-xl mx-auto">
        <div class=" basis-2/3 lg:basis-1/4 gap-2 flex items-center">
            <div class="dropdown">
            ...
            <div class=" w-full">
                <div class="mx-auto relative max-w-96 w-full">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2"
                         stroke="currentColor" class="size-6 opacity-50 absolute z-1 right-2 top-2.5">
        ...
        <div class="text-left basis-1/3 lg:basis-1/4  gap-2">
            ...
            <button class="btn btn-primary btn-soft btn-circle">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2"
                     stroke="currentColor" class="size-5 lg:size-6">
                    <path stroke-linecap="round" stroke-linejoin="round"
